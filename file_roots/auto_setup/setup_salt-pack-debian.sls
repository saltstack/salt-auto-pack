...
{% for platform_release in debian_supported %}

{% set dir_platform_base = base_cfg.build_salt_pack_dir ~ '/file_roots/pkg/salt/' ~ default_branch_prefix ~ '/' ~ platform_release %}
...
update_versions_debian_{{default_branch_version_number}}:
 file.replace:
    - name: {{base_cfg.build_salt_pack_dir}}/file_roots/versions/{{default_branch_version_number}}/debian_pkg.sls
